...
public class Airplane extends Vehicle {
    ...
    public void takeOff() {
        if (isOn && hasLanded) {
            ...
            System.out.println("The airplane is off or hasn't landed, so it cannot take off!");
        }
    }
    ...
    public void land() {
        if (isOn && hasTakenOff) {
            ...
            System.out.println("The airplane is off or hasn't taken off, so it cannot land!");
        }
    }
}
